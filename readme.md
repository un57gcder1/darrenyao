...
I currently compete in the Platinum division of the USA Computing Olympiad (top 200 students nationally). In addition, I'm the author of the book _An Introduction to the USA Computing Olympiad_, written as a one-stop-shop comprehensive training resource for the Bronze and Silver divisions of the [USACO](http://usaco.org). This book was written as the "Art of Problem Solving" of competitive programming, to fulfill the need of a textbook aimed for the USACO. Links to the book are below:
